    ...
    <header className="mb-12">
      ...
      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-white/20 dark:border-slate-700/30 rounded-2xl shadow-lg">
        <div className="flex justify-between items-center px-6 py-4">
          {/* Left section - Apple-style back navigation */}
          <div className="flex items-center space-x-4 min-w-0 flex-1">
            {showBackButton && onBackClick && (
              <button
                onClick={onBackClick}
                className="flex items-center space-x-2 px-3 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100/50 dark:hover:bg-slate-700/50 rounded-xl transition-all duration-200 group"
              >
          ...
          {/* Center section - Apple-style wordmark */}
          ...
          {/* Right section - Apple-style theme toggle */}
